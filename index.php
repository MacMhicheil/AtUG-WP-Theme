          ...
          <div class="jumbotron jumbotron-fluid" style="background-color: whitesmoke">
            ...
            <?php if ( have_posts() ) : ?>
                <?php while ( have_posts() ) : the_post(); ?><div class="row">
                    ...
                    <p><a href="<?php comments_link(); ?>"><button type="button" class="btn btn-primary" style="background-color: #556b2f !important; border-style: none;"><i class="fa fa-comment"></i> 
                    	<?php
						...
						?></button></a>
						 <a href="https://twitter.com/intent/tweet?text=<?php the_title(); ?>%20<?php echo the_permalink(); ?>&hashtags=LCDTE&#44LGBTI&#44Gàidhlig&#44Gaelic&via=GeidhUK"><button type="button" class="btn btn-primary" style="background-color: #556b2f !important; border-style: none;"><i class="fa fa-twitter"></i> Twitter</button></a>
						 <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo the_permalink(); ?>&t=#<?php the_title(); ?>"><button type="button" class="btn btn-primary" style="background-color: #556b2f !important; border-style: none;"><i class="fa fa-facebook"></i> Facebook</button></a>
					</p>
